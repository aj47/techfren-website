import { Box, Container, Heading, SimpleGrid, Text, Link, Image, VStack, HStack, IconButton, useColorMode, useColorModeValue, Switch } from "@chakra-ui/react";
...
const ColorModeSwitcher = () => {
  ...
  return <Switch position="fixed" top="1rem" right="1rem" color="green" isChecked={colorMode === "dark"} onChange={toggleColorMode} icon={colorMode === "light" ? <FaMoon /> : <FaSun />} size="lg" />;
};
